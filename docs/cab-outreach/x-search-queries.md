# X/Twitter Search Queries — AgentLens Prospect Finding
...
Searches for people with adjacent problems that AgentLens solves — cost visibility, unexpected bills, optimization work.
