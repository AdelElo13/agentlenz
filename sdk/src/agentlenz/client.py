"""HTTP client that batches and sends span events to the AgentLenz backend."""
...
from agentlenz.config import get_config
from agentlenz.spans import Span

logger = logging.getLogger("agentlenz")
...
class EventClient:
    ...
    def flush(self) -> None:
        ...
        try:
            ...
            logger.warning("AgentLenz: failed to send %d events", len(batch), exc_info=True)
